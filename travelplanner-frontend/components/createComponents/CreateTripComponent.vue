  ...
  <div class="relative md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
      <div class="px-4 sm:px-0">
        <h3 class="text-lg font-medium leading-6 text-gray-900">Add a trip</h3>
        <p class="mt-1 text-sm text-gray-600">The "Create a Trip" function allows users to add new trip details, such as destinations, dates, and activities, to the platform.</p>
      </div>
    </div>
...
const { postTrip } = useTripResources();
...
const submitTrip = async () => {
  ...
  try {
    const result = await postTrip(trip.value);
    if (result) {
