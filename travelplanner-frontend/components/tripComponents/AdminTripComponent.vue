...
import AdminSeparateCardsComponent from "~/components/cardComponents/AdminSeparateCardsComponent.vue";
  ...
  <div class="relative bg-gray-900">
    <div class="flex min-h-full flex-col justify-start py-16 sm:px-6 lg:px-8 z-0">
      <div class="text-center text-white mb-5 mt-5">
        <h1 class="text-3xl font-bold sm:text-3xl">Admin page</h1>
        <p class="mt-4 text-md font-light">Admin can do all operation on every persons trip.</p>
      </div>
