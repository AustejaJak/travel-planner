  ...
  <div class="relative isolate overflow-hidden bg-gray-900 z-0">
    ...
    <div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
        ...
        <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Start Your Adventure</h1>
        <p class="mt-6 text-lg leading-8 text-gray-300">Discover how you can turn your travel dreams into reality. Plan your dream trips and explore the world with ease. Create itineraries, book experiences, and navigate with confidence—all in one website.<br><i class="text-gray-100">Embark on the journey of a lifetime. Wherever you go, we’ve got you covered.</i></p>
      ...
      <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mt-0 lg:mr-0 lg:max-w-none lg:flex-none xl:ml-32">
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
          <img src="C:\travelplanner\travelplanner-frontend\assets\pictures\travelling.jpg" alt="Travelling picture" width="2432" height="1442" class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 opacity-80" />
        </div>
      </div>
    </div>
  </div>
